                        ...
                        <div class="card card-table">
                            ...
                            <div class="card-body table-responsive">
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="user-avatar"> <img src="images/avatar6.png" alt="Avatar">Penelope
                                                Thornton</td>
                                        ...
                                        <tr>
                                            <td class="user-avatar"> <img src="images/avatar4.png" alt="Avatar">Benji
                                                Harper</td>
                                        ...
                                        <tr>
                                            <td class="user-avatar"> <img src="images/avatar5.png" alt="Avatar">Justine
                                                Myranda</td>
                                        ...
                                        <tr>
                                            <td class="user-avatar"> <img src="images/avatar3.png" alt="Avatar">Sherwood
                                                Clifford</td>
                            ...
                            <div class="widget-chart-container">
                                <div class="widget-chart-info mb-4">
                                    <div class="indicator indicator-positive float-right"><span
                                            class="icon mdi mdi-chevron-up"></span><span class="number">15%</span></div>
